...
A curated list of tools that can be used for creating interactive mathematical explorables on web. Feel free to add tools that are not listed here.
 ...
 - [Geogebra emdeded](https://wiki.geogebra.org/en/Embedding_in_Webpages)
 ...
 - [Mafs](https://mafs.dev/) - set of opinionated React components for creating math visualizations.
